...
constexpr const char* const FIRSTNAME = "Mateusz";
constexpr const char* const SURNAME   = "Poweska";
constexpr const char* const MAIL    = "mpoweska@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "407238";
